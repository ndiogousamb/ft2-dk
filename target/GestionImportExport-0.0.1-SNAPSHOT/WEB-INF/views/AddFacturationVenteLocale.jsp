...
<body ng-controller="ImportExportController"
	ng-init="EspeceDemouleePourReglerFactureVenteLocale()">
				...
				<div class="panel-body">
					<table class="table table-striped">
						...
						<tr ng-repeat="e in listEspecesDemouleesAchetees | filter:search">
							...
							<td
								ng-if="e.especeDemoulee.grosPoisson.libelleCalibreGP!='GROS POISSON'">{{e.nombreCartonAchete}}</td>
							<td
							...
							<td
								ng-if="e.especeDemoulee.grosPoisson.libelleCalibreGP!='GROS POISSON'"><input
								class="form-control" type="text"
								ng-model="e.montant=e.nombreCartonAchete*e.prixunitaire"
								width="1px" readonly /></td>
						</tr>
					</table>
					<table>
						<tr>
							<b> MONTANT TOTAL: {{ (getTotalEspeceAchetees()) }}</b>
						</tr>
					</table>

					<center>
						<button class="btn btn-primary btn-lg"
							ng-click="saveFactureVenteLocale()" type="submit">Valider</button>
						<button class="btn btn-primary btn-lg"
