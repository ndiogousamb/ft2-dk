	...
	<div id="general">
		<div id="head">
			...
			<img
				...
				class="config"> <a
				href="<%=request.getContextPath()%>/user/login?logout"> <img
		...
		<div id="droite">
			<a href="<%=request.getContextPath()%>/production/addProduction">
				<img src="<%=request.getContextPath()%>/static/assets/img/ajouter_produit.png" class="ajoupro">
			</a> 
			<a href="<%=request.getContextPath()%>/production/ListeProductionAModifier"> <img src="<%=request.getContextPath()%>/static/assets/img/modifier_produit.png" class="modpro">
			</a> 
			<a href="<%=request.getContextPath()%>/production/ListeProduction/">
				<img src="<%=request.getContextPath()%>/static/assets/img/consulter_produit.png" class="conpro">
			</a>
		</div>
