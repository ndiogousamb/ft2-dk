...
<title>MENU DEBARQUEMENT -FT2-DAKAR</title>
...
<body>
	...
	<div id="general">
		...
		<div id="gauche">
			...
			<div id="droite">
			<a href="<%=request.getContextPath()%>/debarquement/addDebarquement">
				<img src="<%=request.getContextPath()%>/static/assets/img/ajouter_debarquement.png" class="ajoudeb">
			</a> 
			<a href="#"> <img src="<%=request.getContextPath()%>/static/assets/img/modifier_debarquement.png" class="modideb">
			</a> 
			<a href="<%=request.getContextPath()%>/debarquement/ListeDebarquement">
				<img src="<%=request.getContextPath()%>/static/assets/img/consulter_debarquement.png" class="condeb">
			</a>
		</div>
