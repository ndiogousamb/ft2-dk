...
<body ng-controller="ImportExportController"
	ng-init="getEspeceProduiteByCodePourFacturation()">
				...
				<div class="panel-body">
					<table class="table table-striped">
						...
						<tr ng-repeat="e in listEspecesProduites | filter:search">
							...
							<td>{{e.prixEspeceCalibree}}</td>
							<td>{{e.montant}} FRS CFA</td>
						</tr>
					...
					<table>
						...
						<tr ng-repeat="e in listEspecesProduites" ng-if="$index <1">
							<label>MONTANT TOTAL:</label>
							<td><b> <font size="3px">{{e.production.montantProduction}}
										FRS CFA</font></b></td>
						</tr>
					</table>
					...
					<center>
						<button class="btn btn-primary btn-lg"
							ng-click="ImprimerFactureProduction()" type="submit">Imprimer</button>
						<button class="btn btn-primary btn-lg"
							onclick="location.href='<%=request.getContextPath()%>/facturation/MenuFacturationProduction'"
