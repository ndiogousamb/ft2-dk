...
<title>MENU EXPORTATION -FT2-DAKAR</title>
...
<body>
	...
	<div id="general">
		...
		<div id="droite">
			<a href="<%=request.getContextPath()%>/exportation/addExportation">
				<img src="<%=request.getContextPath()%>/static/assets/img/ajouter_exportation.png" class="ajoupro">
			</a> 
			<a href="#"> <img src="<%=request.getContextPath()%>/static/assets/img/modifier_exportation.png" class="modpro">
			</a> 
			<a href="<%=request.getContextPath()%>/exportation/ListeExportationAConsulter">
				<img src="<%=request.getContextPath()%>/static/assets/img/consulter_exportation.png" class="conpro">
			</a>
		</div>
