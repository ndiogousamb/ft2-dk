...
<title>CONSULTER FACTURATION PRODUCTION-FT2-DAKAR</title>
...
<body ng-controller="ImportExportController"
	ng-init="getListProductionRegle()">
						...
						<table class="table table-striped">
							...
							<tr ng-repeat="p in listProduction | filter:search">
								...
								<td><a ng-click="ChargerCode()"
									href="<%=request.getContextPath()%>/facturation/production/GetFacturationProduction?{{p.id}}">{{p.codeProduction}}</a></td>
								<td>{{p.dateDebut}}</td>
								<td>{{p.dateFin}}</td>
