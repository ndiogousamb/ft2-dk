...
<title>MENU VENTE LOCALE-FT2-DAKAR</title>
...
<body>
	...
	<div id="general">
		...
		<div id="droite">
			<a href="<%=request.getContextPath()%>/VenteLocale/addVenteLocale">
				<img
				src="<%=request.getContextPath()%>/static/assets/img/creer_vente.png"
				class="crven">
			</a> <a href="<%=request.getContextPath()%>/VenteLocale/ListeVenteLocaleAModifier"> <img
				src="<%=request.getContextPath()%>/static/assets/img/modifier_vente.png"
				class="modven">
			</a> <a href="<%=request.getContextPath()%>/VenteLocale/ListeVenteLocaleAConsulter">
				<img
				src="<%=request.getContextPath()%>/static/assets/img/consulter_vente.png"
				class="conven">
			</a>
		</div>
