...
<title>FACTURATION VENTE LOCALE-FT2-DAKAR</title>
...
<body ng-controller="ImportExportController"
	ng-init="EspeceDemouleeDejaFacturer_VenteLocale()">
		...
		<div id="droite">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<font size="3px"> <label
						ng-repeat="e in listEspecesDemouleesAchetees" ng-if="$index <1">
							{{e.achat.codeAchat}}<br> PRENOM :
							{{e.achat.client.prenomClient}}<br> NOM :
							{{e.achat.client.nomClient}} <br> Liste des ESPECES De
							l'ACHAT: {{e.achat.codeAchat}}
					</label></font>
				</div>
				<div class="panel-body">
					<table class="table table-striped">
						...
						<tr ng-repeat="e in listEspecesDemouleesAchetees | filter:search">
							...
							<td
								ng-if="e.especeDemoulee.grosPoisson.libelleCalibreGP!='GROS POISSON'">{{e.nombreCartonAchete}} CARTON</td>
							<td
								ng-if="e.especeDemoulee.grosPoisson.libelleCalibreGP=='GROS POISSON'"></td>
							<td>{{e.poids}} KGS</td>
							<td>{{e.prixUnitaire}} FCFA</td>
							<td>{{e.montant}} FCFA</td>
						</tr>


					</table>
					<table>
						<tr ng-repeat="e in listEspecesDemouleesAchetees" ng-if="$index <1">
							<label>MONTANT TOTAL:</label>
							<td><b> <font size="3px">{{ e.achat.montantAchat}} FCFA</font></b></td>
						</tr>
					</table>

					<center>
						<button class="btn btn-primary btn-lg"
							ng-click="ImprimerFactureVenteLocale()" type="submit">Imprimer</button>
						<button class="btn btn-primary btn-lg"
							onclick="location.href='<%=request.getContextPath()%>/facturation/menu'"
