...
<body ng-controller="ImportExportController"
	ng-init="getListExportationAConsulter()">
	...
	<div id="general">
		<div id="head">
			...
			</div> <a href="<%=request.getContextPath()%>/exportation/menu"> <img
			...
			<div class="panel-body">
				<table class="table table-striped">
					...
					<tr ng-repeat="p in listExportation | filter:search">
						...
						<td><a
							href="<%=request.getContextPath()%>/exportation/GetExportation?{{p.id}}">{{p.codeExportation}}</a></td>
