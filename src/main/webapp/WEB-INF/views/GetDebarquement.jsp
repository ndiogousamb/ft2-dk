...
<body ng-controller="ImportExportController"
	ng-init="getEspeceDemouleByCodePourConsulter()">
					...
					<div class="panel-body">
						<table class="table table-striped">
							...
							<tr ng-repeat="e in listEspecesDemoulees | filter:search">
								...
								<td>{{e.qualite.libelleQualite}}</td>
								<td>{{e.poids}} KGS</td>
								<td>{{e.nombre}}</td>
						...
						<center > <button class="btn btn-primary btn-lg"
							...
							onclick="location.href='<%=request.getContextPath()%>/facturation/production'" type="submit">Annuler</button> </center>
