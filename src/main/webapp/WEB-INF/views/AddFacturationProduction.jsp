...
<title>FACTURATION PRODUCTION-FT2-DAKAR</title>
...
<body ng-controller="ImportExportController"
	ng-init="EspeceProduiteByCodeNonRegle()">
				...
				<div class="panel-heading">
					...
					<font size="5px"> <label
						ng-repeat="e in listEspecesProduites" ng-if="$index <1">
							Marayeur : {{e.production.marayeur.prenomMarayeur}}
				...
				<div class="panel-body">
					<table class="table table-striped">
						...
						<tr ng-repeat="e in listEspecesProduites | filter:search">
							...
							<td ng-model="e.calibre.libelleCalibre">{{e.calibre.libelleCalibre}}</td>
							<td>{{e.plaignat}}</td>
							<td><input class="form-control" type="text"
								ng-model="e.prixunitaire" ng-trim="false" width="1px" /></td>
							<td><input class="form-control" type="text"
								ng-model="e.montant=e.plaignat*e.prixunitaire" width="1px"
								ng-if="e.calibre.libelleCalibre!='GROS POISSON'" readonly /> <input
								class="form-control" type="text"
								ng-model="e.montant=e.prixunitaire" width="1px"
								ng-if="e.calibre.libelleCalibre=='GROS POISSON'" readonly /></td>
					...
					<center>
						<button class="btn btn-primary btn-lg"
							ng-click="saveFactureProduction()" type="submit">Valider</button>
						<button class="btn btn-primary btn-lg"
