...
<title>DEBARQUEMENT-FT2-DAKAR</title>
...
<!-- BOOTSTRAP STYLES-->
<link href="<%=request.getContextPath()%>/static/assets/css/autre.css"
	rel="stylesheet" />
<!-- FONTAWESOME STYLES-->
<link
...
<body ng-controller="ImportExportController"
	ng-init="getListTousLesDebarquement()">
	...
	<div id="general">
		...
		<div id="droite">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">Liste des Debarquements</div>
				<div class="panel-body">
					<table class="table table-striped">
						...
						<tr ng-repeat="p in listDebarquement | filter:search ">
							...
							<td><a
								href="<%=request.getContextPath()%>/debarquement/GetDebarquement?{{p.id}}">{{p.codeDebarquement}}</a></td>
	...
	<script
		src="<%=request.getContextPath()%>/static/assets/js/jquery-1.12.4.js"></script>
	<script
		src="<%=request.getContextPath()%>/static/assets/js/dataTables.bootstrap.js"></script>
