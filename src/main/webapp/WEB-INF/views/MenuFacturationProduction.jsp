...
<title>MENU FACTURATION PRODUCTION -FT2-DAKAR</title>
...
<body>
	<div id="general">
		<div id="head">
			...
			<div id="droite">
		<a href="<%=request.getContextPath()%>/facturation/production">
				<img
				...
				class="modpro">
			</a> <a href="<%=request.getContextPath()%>/facturation/production/ListeFacturationProductionAconsulter/">
				<img
