...
<title>MENU FACTURATION EXPORTATION -FT2-DAKAR</title>
...
<body>
	...
	<div id="general">
			...
			<div id="droite">
			<a href="<%=request.getContextPath()%>/facturation/exportation">
				<img
				...
				class="modpro">
			</a> <a href="<%=request.getContextPath()%>/facturation/exportation/ListeFacturationExportationAConsulter">
				<img
