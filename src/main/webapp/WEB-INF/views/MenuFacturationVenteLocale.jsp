...
<title>MENU FACTURATION VENTE LOCALE -FT2-DAKAR</title>
...
<body>
	...
	<div id="general">
			...
			<div id="droite">
			<a href="<%=request.getContextPath()%>/facturation/VenteLocale">
				<img
				...
				class="modpro">
			</a><a href="<%=request.getContextPath()%>/facturation/VenteLocale/ListeFacturationVenteLocaleAConsulter">
				<img
