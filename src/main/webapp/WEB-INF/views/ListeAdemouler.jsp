...
<title>DEMOULAGE PRODUCTION-FT2-DAKAR</title>
...
<body ng-controller="ImportExportController"
	ng-init="getListProductionNonDemoule()">
						...
						<table class="table table-striped">
							<thead>
								<tr>
									...
									<th scope="row">PRENOM MAREYEUR</th>
									<th scope="row">NOM MAREYEUR</th>
									<th scope="row">CIN MAREYEUR</th>
