...
<body ng-controller="ImportExportController"
	ng-init="getListDebarquementRegle()">
					...
					<div class="panel-body">
						<table class="table table-striped">
							...
							<tr ng-repeat="p in listDebarquement | filter:search">
								...
								<td><a href="<%=request.getContextPath()%>/facturation/debarquement/GetFacturationDebarquement?{{p.id}}">{{p.codeDebarquement}}</a></td>
								...
								<td><a data-toggle="modal"
									data-target="#ModalDesactivation" data-whatever="@mdo">Modifier</a><br> <a data-toggle="modal"
									data-target="#ModalActivation" data-whatever="@mdo">Supprimer</a><br></td>
