...
<title>CONSULTATION FACTURATION EXPORTATION-FT2-DAKAR</title>
...
<body ng-controller="ImportExportController"
	ng-init="EspeceTransporteExportation()">
				...
				<div class="panel-body">
					<table class="table table-striped">
						...
						<tr ng-repeat="e in listEspecesTransportees | filter:search">
							...
							<td>{{e.poids}} KGS</td>
								<td>{{e.prixUnitaire}} FRS CFA</td>
							<td>{{e.montantPartiel}} FRS CFA</td>
						</tr>


					</table>
					<table>
						<tr ng-repeat="e in listEspecesTransportees" ng-if="$index <1">
							<label>MONTANT TOTAL:</label>
							<td><b> <font size="3px">{{e.exportation.montantExportation}} FRS CFA </font></b></td>
						</tr>
					</table>
					</table>
					<center>
						<button class="btn btn-primary btn-lg"
							ng-click="saveFactureExportation()" type="submit">Imprimer</button>
						<button class="btn btn-primary btn-lg"
